...
if [ ! -f Gemfile ]; then
  ...
  echo ""
  echo "docker run -p 4000:4000 -v \$(pwd):/site hubbsy642/jekyll"
  echo ""
  echo "NOTE: To create a new site, you can use the sister image hubbsy642/jekyll like:"
  echo ""
  echo "docker run -v \$(pwd):/site hubbsy642/jekyll new ."
  exit 1
fi
